...
export default function SuperAdminDashboardPage() {
  ...
  const statCards = [
    { label: 'Workshops', value: totals.workshops, icon: Building2, color: 'bg-blue-50 text-blue-600', href: '/dashboard/admin/autofield/workshops' },
    { label: 'Customers', value: totals.customers, icon: Users, color: 'bg-green-50 text-green-600', href: '/dashboard/admin/autofield/users' },
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/dashboard/admin/autofield/users"
            ...
            <Link
              href="/dashboard/admin/autofield/workshops"
