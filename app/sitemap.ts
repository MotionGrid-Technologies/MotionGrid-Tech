...
const staticRoutes = [
  ...
  { path: "/technology/frontend", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/technology/backend", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/technology/other-technologies", changeFrequency: "monthly" as const, priority: 0.5 },
